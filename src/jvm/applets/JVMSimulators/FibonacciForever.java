...
* DERIVATIVES.
*/
package jvm.applets.JVMSimulators;

import java.awt.Color;

import jvm.applets.JVMSimulators.com.artima.jvmsim.JVMSimulator;
import jvm.applets.JVMSimulators.com.artima.jvmsim.OpCode;

/**
 * This class is the personality module for the Fibonacci Forever simulation
 * applet.
 *
 * @author Bill Venners
 */
public class FibonacciForever extends JVMSimulator {
	...
	private static int[] theProgram = { OpCode.LCONST_1, OpCode.LSTORE_0, OpCode.LCONST_1, OpCode.LSTORE_2,
			OpCode.LCONST_1, OpCode.LSTORE, 4, OpCode.LLOAD_0, OpCode.LLOAD_2, OpCode.LADD, OpCode.LSTORE, 4,
			OpCode.LLOAD_2, OpCode.LSTORE_0, OpCode.LLOAD, 4, OpCode.LSTORE_2, OpCode.GOTO, (byte) 0xff, (byte) 0xf6 };

	private static String[] bytecodeMnemonics = { "lconst_1", "lstore_0", "lconst_1", "lstore_2", "lconst_1",
			"lstore 4", "", "lload_0", "lload_2", "ladd", "lstore 4", "", "lload_2", "lstore_0", "lload 4", "",
			"lstore_2", "goto 7", "", "" };
